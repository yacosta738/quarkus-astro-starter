...
import com.quarkus.astro.security.RandomUtil.generateActivationKey
import com.quarkus.astro.security.RandomUtil.generatePassword
import com.quarkus.astro.security.RandomUtil.generateResetKey
...
class UserService @Inject constructor(private val passwordHasher: BCryptPasswordHasher) {
    ...
    fun getAllManagedUsers(): List<UserDTO> {
        return userRepository.findAllByLoginNot(Page.ofSize(20), com.quarkus.astro.config.Constants.ANONYMOUS_USER).stream()
            .map { UserDTO() }
